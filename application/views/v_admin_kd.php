        ...
        <div class="container">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <?php $nm_distribusi = $this->db->query("
                            SELECT * from distribusi
                            order by nm_distribusi ASC limit 0,3
                        ")->result_array(); ?>
                       <?php foreach ($nm_distribusi as $keys ): ?>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                ...
                                <div class="posko">
                                    <h4><?php echo $keys["nm_distribusi"];?></h4>
                                ...
                                Status Distribusi : <?php echo $keys["status_distribusi"];?> <br>
                                <a href="<?php echo base_url()?>detail_posko_ad" class="btn py-2 px-3 btn-primary">
                                    Detail
                                </a>
                              </p>
